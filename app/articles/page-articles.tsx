...
export default function PostsPage() {
  ...
  if (error) return <div className="h-screen flex items-center justify-center text-red-500">Impossible de charger les articles ❌</div>;
      ...
      <main className="flex w-full max-w-5xl flex-col items-center sm:items-start py-24 px-6 sm:px-6 lg:px-8">
        <section className="mb-12 text-center sm:text-left w-full">
          ...
          <p className="font-sans text-lg text-zinc-600 dark:text-zinc-400 max-w-2xl">
            Retrouvez ici tous mes articles sur le développement web, le design et la tech.
          </p>
        </section>
        ...
        <section className="w-full mb-8">
          <div className="relative max-w-xl">
            ...
            />
            <Search size={18} className="absolute right-4 top-1/2 -translate-y-1/2 text-zinc-400 dark:text-zinc-500" />
          </div>
        </section>
